 ...
 <body>
	<div id="wrap">
        ...
        <div class="slide_img">
		  ...
		  <form class="board_write" action="review_write_control.php" method="POST">
        ...
        <p>
			  ...
			  <div class="btn_group">
          <a href="review_edit.php?no=<?=$row['no']?>" title="수정"><input class="button" type="button" value="수정"/></a>
  				<a href="review_delete.php?no=<?=$row['no']?>" title="삭제"><input class="button" type="button" value="삭제"/></a>
