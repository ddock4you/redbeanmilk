<?php
	...
	$result = mysql_query("SELECT *FROM notice WHERE no='$no' ");
 ...
 <body>
	<div id="wrap">
        ...
        <div class="slide_img">
		  ...
		  <form class="board_write" action="notice_write_control.php" method="POST">
        ...
        <p>
			  ...
			  <div class="btn_group">
          <a href="notice_edit.php?no=<?=$row['no']?>" title="수정"><input class="button" type="button" value="수정"/></a>
  				<a href="notice_delete.php?no=<?=$row['no']?>" title="삭제"><input class="button" type="button" value="삭제"/></a>
  				<a href="notice_list.php" title="목록"><input class="button" type="button" value="목록"/></a>
			  </div>
		  </form>
		</div>
		<div id="footerWrap">
