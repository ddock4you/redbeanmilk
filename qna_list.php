<?php
	...
	$result = mysql_query("SELECT *FROM qna ORDER BY no DESC");
	...
	<div id="wrap">
        ...
        <div class="slide_img">
          ...
          ?>
				<tr>
				  <td class="table_no">
					  <a href="qna_read.php?no=<?=$row['no']?>" title="no">
					    <?=$rowCnt-$cnt?>
					  </a>
				  </td>
				  <td class="table_title">
            <a href="qna_read.php?no=<?=$row['no']?>" title="title">
              <?=$row['title']?>
            </a>
				  </td>
        ...
        <?php }else { ?>
        						<a href="qna_write.html" title="글쓰기">글쓰기</a>
        <?php }?>
		  </div>
		</div>
		<div id="footerWrap">
