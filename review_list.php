<?php
	...
	$result = mysql_query("SELECT *FROM review ORDER BY no DESC");
	...
	<div id="wrap">
        ...
        <div class="slide_img">
		  ...
		  <div class="table_area">
			<table>
			  <caption class="blind">REVIEW</caption>
			  <thead>
				<tr>
          ...
          ?>
				<tr>
				  <td class="table_no">
					  <a href="review_read.php?no=<?=$row['no']?>" title="no">
					    <?=$rowCnt-$cnt?>
					  </a>
				  </td>
				  <td class="table_title">
            <a href="review_read.php?no=<?=$row['no']?>" title="title">
              <?=$row['title']?>
            </a>
				  </td>
				  <td class="table_person"><?=$row['name']?></td>
				  <td class="table_date"><?=date('y-m-d',strtotime($row['wdate']));?></td>
        ...
        <?php }else { ?>
        						<a href="review_write.html" title="글쓰기">글쓰기</a>
        <?php }?>
		  </div>
		</div>
		<div id="footerWrap">
